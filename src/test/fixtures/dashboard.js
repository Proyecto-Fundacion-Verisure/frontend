// `DashboardResponse` de GET /api/dashboard. Cifras inventadas pero con la
// forma exacta del contrato; los tests de la página montan la respuesta desde
// aquí, no desde ningún mock de desarrollo.
export const DASHBOARD_RESPONSE = Object.freeze({
  ...
  participationByOrganization: [
    { id: 'VERISURE_ES', label: 'Verisure España', participants: 402 },
    { id: 'VERISURE_GROUP', label: 'Verisure Group', participants: 196 },
  ],
  participationByLine: [
    { id: 'desoledad', label: 'Desoledad', participants: 310 },
    { id: 'educar', label: 'Educar para proteger', participants: 188 },
    { id: 'medioambiente', label: 'Medioambiente', participants: 100 },
  ],
  distributionByMode: [
