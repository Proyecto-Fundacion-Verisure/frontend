...
export const MOCK_PROPOSALS_V2 = [
  ...
  makeProposal({ id: 4, organizationName: 'Voluntarios Activos', cif: 'A55667788', contactName: 'Pedro López', email: 'pedro@voluntarios.org', line: 'voluntariado', status: ProposalStatus.ACCEPTED }),
