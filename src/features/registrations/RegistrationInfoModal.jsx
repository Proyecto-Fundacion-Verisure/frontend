  ...
  return (
    ...
    >
      <div id="registration-info-description">
        ...
        <ul>
          <li><strong>Aceptada</strong> corresponde a <code>accepted=true</code> — la administración ha validado tu solicitud.</li>
          <li>Si hay plaza disponible, podrá pasar a <strong>CONFIRMED</strong>.</li>
          <li>Si el aforo está completo, continuarás en cola con posición asignada (queuePosition) hasta que quede plaza.</li>
        </ul>
